    ...
    <section className="py-10 w-[80%] lg:w-[60%] mx-auto">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <h2 className="text-2xl font-bold mb-4">Startup Projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link
              to="/research/fuelture"
              className="block rounded-2xl border border-slate-200 bg-white shadow hover:shadow-lg transition-shadow p-6 no-underline group"
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center text-blue-700 font-black text-lg">F</div>
                <span className="font-bold text-slate-800 text-lg group-hover:text-blue-600 transition-colors">Fuelture Technologies</span>
              </div>
              <p className="text-sm text-slate-500 leading-relaxed">
                AI-powered maritime bunker fuel procurement platform. Quantum-ready optimization for shipping fuel cost reduction.
              </p>
              <span className="inline-block mt-3 text-xs font-semibold text-blue-600 bg-blue-50 px-3 py-1 rounded-full">View Project →</span>
            </Link>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <img src="/projects/q-health-logo.png" alt="Q-Health" className="w-10 h-10 object-contain rounded-lg" />
                <span className="font-bold text-slate-800 text-lg group-hover:text-teal-600 transition-colors">Q-Health Technologies</span>
              </div>
              <p className="text-sm text-slate-500 leading-relaxed">
                Quantum × AI for hospital operating theatre scheduling. Real-time optimization to boost utilization from 50–60% to over 80%.
              </p>
              <span className="inline-block mt-3 text-xs font-semibold text-teal-600 bg-teal-50 px-3 py-1 rounded-full">View Project →</span>
            </Link>
          </div>
        </div>
